        ...
        <div className='h-screen w-screen flex justify-center items-center bg-teal-400'>
            <div className='flex flex-col items-center gap-4 bg-white p-4 py-8 h-96 justify-center w-80'>
                ...
                <div className='flex flex-col gap-6 items-center w-full'>
                    ...
                    <button className='bg-black text-white p-2 w-2/5' onClick={handleLogin}>Login</button>
                </div>
                <div className='text-sm'>Don't have an account ? <span className='text-blue-700 cursor-pointer'><Link href='signup'>Signup</Link></span></div>
            </div>
        </div>
    )
}
