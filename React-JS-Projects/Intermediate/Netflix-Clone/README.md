...
<div>
  <!-- <p>Add Description of the project</p> -->
    <p>A Netflix clone built with React and integrated with the TMDB API, allowing users to browse and view real-time movie and TV show data with a sleek UI</p>
</div>
