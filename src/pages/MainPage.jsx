...
const MainPage = ({ page }) => {
  // const { page, routes, setProgress, query } = props;
  ...
  return (
    <div style={{maxWidth: '80rem', width: '100%'}} className="d-flex flex-column gap-3 my-3 justify-content-center align-items-center">
