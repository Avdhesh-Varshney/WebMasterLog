...
<div>
  <!-- <p>Add Description of the project</p> -->
    <p>This project is a project in HTML, CSS and Vanilla Js that generates random memes with pictures.</p>
</div>
...
2. Clone the repository to your local computer:
   git clone https://github.com/your-username/Meme-Generator-Clone.git
